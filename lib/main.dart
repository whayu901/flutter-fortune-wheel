...
class _SpinWheelScreenState extends State<SpinWheelScreen> {
  ...
  final items = ['Prize 1', 'Prize 2', 'Prize 3', 'Prize 4', 'Prize 5'];
        ...
        child: Column(
          ...
          children: [
            FortuneWheel(
              ...
              onAnimationStart: _playSound, // Play sound when animation starts
            ),
            const SizedBox(height: 50),
            ElevatedButton(
              onPressed: () {
                final randomIndex = Random().nextInt(items.length);
                selected.add(randomIndex); // Spin to a random item
              },
